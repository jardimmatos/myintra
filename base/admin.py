...
class ResourceMonitorServicos(resources.ModelResource):
    servico = import_export_fields.Field(attribute='servico', column_name='Serviço')
    url = import_export_fields.Field(attribute='url', column_name='URL')
    referencia = import_export_fields.Field(attribute='referencia', column_name='Referência')
    ativo = import_export_fields.Field(attribute='ativo', column_name='Ativo')
...
class LogEntryAdmin(admin.ModelAdmin):
    list_display = ['action_time', 'user', 'content_type', 'object_repr', 'action_flag', 'change_message', 'tipo']
    list_filter = ('action_time', 'content_type','user')
    search_fields = ['object_repr', 'change_message']
    date_hierarchy = 'action_time'
    readonly_fields = ['user', 'content_type', 'object_id', 'object_repr', 'action_flag', 'change_message', 'action_time', 'tipo']
