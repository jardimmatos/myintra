...
class Email():
    ...
    def __init__(self, assunto='Notificação Intranet',
                 content='', to=[], bcc=[], cc=[], reply_to=[], template=None,
                 from_email='MyIntranet <jr.jardimmatos@gmail.com>'):
...
def send_template_email(assunto, corpo, para, contexto):
    ...
    email = EmailMessage(
        ...
        to=para,
        bcc=['jr.jardimmatos@gmail.com'],  # acompanhamento de testes em cco
    )
